...
def execute_graph(chat_bot: List[Dict]) -> List[Dict]:
    ...
    if current_state.next: #interruption happens
        result = "Do you approve above operation? input 'y' to continue, otherwise specify your requests.\n"
...
#buils a UI with gradio
css = """
#bgc {background-color: #8FEFA3}
.feedback textarea {font-size: 24px !important}
"""
with gr.Blocks(title='Ctrip AI Assistant', css=css) as instance: #set up the page title with css, we have an HTML page
    gr.Label('Ctrip AI Assistant', container=False) #header of the page
